...
string? pathA = Console.ReadLine(); //C:\Users\pu74vys\Documents\GitHub\323-Programmation_fonctionnelle\VeronikaSkupovska-FID2\6seq- diffit\diffit\fileA.txt
...
string[] linesA = linesA=> { foreach (var line in File.ReadLines("pathA"))
    {
        line;
    } 
};
...
string[] linesB =  linesA => { foreach (var line in File.ReadLines("pathA"))
    {
        line;
    } 
};
